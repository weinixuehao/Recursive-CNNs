...
--lr 0.05 --schedule 10 20 30 -v $doc_dataset_test --batch-size 32 --model-type resnet --loader ram

python train_model.py --name CornerModel -i $corner_dataset_train \
--lr 0.05 --schedule 10 20 30 -v $corner_dataset_test --batch-size 32 --model-type resnet --loader ram --dataset corner